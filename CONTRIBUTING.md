...
Please report security issues privately by following the instructions in [SECURITY.md](SECURITY.md).
...
- **[Documentation](https://github.com/FaultMaven/faultmaven)** — Technical guides and API references
